...
class I18n(QObject):
    ...
    def setup(self):
        ...
        I18n.RUNNING_M = self.tr("RUNNING", "image server")
        I18n.RUNNING_F = self.tr("RUNNING", "session")
        I18n.STOPPED_M = self.tr("STOPPED", "image server")
        I18n.STOPPED_F = self.tr("STOPPED", "session")
