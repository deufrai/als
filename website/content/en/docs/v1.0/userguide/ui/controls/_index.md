...
type: "docs"
tags: [ "module", "stack", "session", "image server", "output", "minimum matches", "outlier rejection", "save", "issues", "panels" ]
...
- Use the dropdown list to set the **stacking mode** to use:
    - `mean`
      ...
      ℹ️ _Outliers are rejected automatically once at least **5** subs are present in the stack and the **Astrophoto**
      profile is in use_
