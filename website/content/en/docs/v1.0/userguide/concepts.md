...
tags: [ "module", "stack", "processing", "session", "input", "output", "scan folder", "work folder", "web folder", "image server", "scanner", "save", "calibration", "hot pixels", "dark", "flat", "debayer", "stretch", "levels", "color balance", "saturation", "image adjustment", "outlier rejection", "profile" ]
weight: 100315
---
