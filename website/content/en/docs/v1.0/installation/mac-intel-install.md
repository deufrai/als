...
2. **Identify the ALS disk image**
   - Look for the disk image whose name starts with {{< als-code >}}als{{< /als-code >}} and ends with {{< als-code >}}-amd64.dmg{{< /als-code >}}. For example, it might be {{< als-code >}}als-v1.0-amd64.dmg{{< /als-code >}}.

3. **Mount the disk image**
   - Double-click on the {{< als-code >}}als-v1.0-amd64.dmg{{< /als-code >}} disk image. This will mount the disk image.
