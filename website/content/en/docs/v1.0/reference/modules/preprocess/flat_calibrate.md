...
with ones before dividing the science image.

- If the master flat cannot be read or its dimensions differ from the science frame, the division is
  skipped and the **unmodified** image is returned to the **Preprocess** module.
