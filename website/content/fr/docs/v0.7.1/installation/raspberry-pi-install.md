...
Mais vous pouvez facilement adapter ce [script de build](https://github.com/deufrai/als/blob/v0.7.1/ci/builds/build_dist_arm64_linux.sh)
...
3. **Extraire l'archive**
    - Pour extraire l'archive, vous pouvez utiliser un gestionnaire de fichiers :
        - Faites un clic droit sur l'archive `als-v0.7.1.tgz`.
   ...
   **Pourquoi déplacer ALS en dehors du dossier de téléchargements ?**
   ...
   sécurité.
    ...
    - Accédez au dossier de téléchargements (`Téléchargements`) dans une autre fenêtre de votre gestionnaire de
      ...
      fichiers.
    - Trouvez le dossier `als-v0.7.1` dans le dossier de téléchargements, puis faites glisser ce dossier dans le
      dossier `ALS` (`/home/nom_utilisateur/Applications/ALS`).

5. **Lancer l'exécutable**
    - Accédez au dossier `als-v0.7.1` dans le gestionnaire de fichiers.
    - Faites un double clic sur le fichier `als-v0.7.1`.
