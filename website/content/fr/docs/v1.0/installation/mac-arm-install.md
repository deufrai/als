...
tags: ['installation', 'Mac', 'Apple Silicon Mac']
---
...
2. **Identifier l'image disque als**
   - Recherchez l'image disque dont le nom commence par {{< als-code >}}als{{< /als-code >}} et se termine par {{< als-code >}}-arm64.dmg{{< /als-code >}}. Par exemple, cela pourrait être {{< als-code >}}als-v1.0-arm64.dmg{{< /als-code >}}.

3. **Monter l'image disque**
   - Double-cliquez sur l'image disque {{< als-code >}}als-v1.0-arm64.dmg{{< /als-code >}}. Cela montera l'image disque.
