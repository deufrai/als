function downloadAndOpenInstructions(platform) {
    var urls = {
        'windows': {
            'download': 'https://github.com/deufrai/als/releases/download/v0.7-beta10/als-v0.7-beta10_Setup.exe',
        ...
        'mac-intel': {
            'download': 'https://github.com/deufrai/als/releases/download/v0.7-beta10/ALS-v0.7-beta10-amd64.dmg',
        ...
        'mac-arm': {
            'download': 'https://github.com/deufrai/als/releases/download/v0.7-beta10/ALS-v0.7-beta10-arm64.dmg',
        ...
        'linux': {
            'download': 'https://github.com/deufrai/als/releases/download/v0.7-beta10/als-v0.7-beta10.run',
        ...
        'raspberry-pi': {
            'download': 'https://github.com/deufrai/als/releases/download/v0.7-beta10/als-v0.7-beta10.tgz',
