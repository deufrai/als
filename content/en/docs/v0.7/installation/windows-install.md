...
1. **Open the Downloads Folder**
    ...
    - You should see the installer file that starts with `als` and ends with `_Setup.exe`. For example, it might be
      `als-v0.7-beta7_Setup.exe`.

2. **Run the Installer**
    - Double-click the `als-v0.7-beta7_Setup.exe` file in the folder where you downloaded it to launch the installation.
