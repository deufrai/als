...
1. **Ouvrir le dossier de téléchargements**
    ...
    - Vous devriez y voir l'installeur d'ALS dont le nom commence par `als` et se termine par `_Setup.exe`.
      Par exemple, cela pourrait être `als-v0.7-beta9_Setup.exe`.

2. **Exécuter l'installeur**
    - Double-cliquez sur le fichier `als-v0.7-beta9_Setup.exe` dans le dossier où vous l'avez téléchargé pour lancer 
